...
public class Camera2BasicFragment extends Fragment
    ...
    /**
     * define timer to finish take photo task
     * the time span is 5s
     */
    private int time = 0;
     ...
     */
    private com.shouxin.shouxin.AutoFitTextureView mTextureView;
...
//                                    @Override
//                                    public void run() {
//                                        SendFile sendFile = new SendFile(bytes);
//                                        sendFile.uploadPictureToServer2();
//                                    }
//                                }).start();
//                                Bitmap bitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
//                                if (bitmap != null) {
//                                    View view = getActivity().getLayoutInflater().
//                                            inflate(R.layout.fragment_camera2_basic,null);
//                                    ImageView imageView = view.findViewById(R.id.imageView);
//                                    imageView.setImageBitmap(bitmap);
//                                    bitmap = GrayProcess.getGrayBitmap(bitmap);
//                                    File outputGrayImage = new File(Environment. getExternalStorageDirectory(),
//                                            "GraytempImage.jpg");
//                                    try {
...
//                View view = getActivity().getLayoutInflater().
//                        inflate(R.layout.fragment_camera2_basic,null);
//                TextView textView = view.findViewById(R.id.result_view2);
...
//                    }}).start();
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            new Thread(new MyRunnable(bytes, mFile.getName())).start();
...
class MyRunnable implements Runnable{
    ...
    public MyRunnable(byte[] bytes, String filename){
    ...
    @Override
    public void run() {
        SendFile sendFile = new SendFile(testBuffer, filaname);
        sendFile.uploadPictureToServer2();
    }
}
