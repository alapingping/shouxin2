...
import com.shouxin.shouxin.ternsorflow.*;
...
//    }
    ...
    public static final String TAG = TFActivity.class.getSimpleName();
...
//            finish();
        ...
        this.findViewById(R.id.iv_choose_picture).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

            }
        });
        this.findViewById(R.id.iv_take_photo).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                takePhoto();
            }
    ...
    MessageQueue.IdleHandler idleHandler = new MessageQueue.IdleHandler() {
        ...
        public boolean queueIdle() {
            ...
            if (classifier == null) {
                // 创建 Classifier
                classifier = TensorFlowImageClassifier.create(TFActivity.this.getAssets(),
    ...
    private void showNeedStoragePermissionDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(TFActivity.this,
    ...
    private void handleInputPhoto(Uri imageUri) {
        // 加载图片
        GlideApp.with(TFActivity.this).asBitmap().listener(new RequestListener<Bitmap>() {

            @Override
            public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Bitmap> target, boolean isFirstResource) {
                Log.d(TAG,"handleInputPhoto onLoadFailed");
                Toast.makeText(TFActivity.this, "图片加载失败", Toast.LENGTH_SHORT).show();
                return false;
            }
